    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="border border-white/10 rounded-2xl p-10 bg-white/5 flex flex-col items-center gap-6 w-full max-w-sm">
        ...
        <form
          ...
          className="w-full"
        >
          <button className="w-full bg-white/5 border border-white/10 text-white font-medium text-sm py-2.5 rounded-lg hover:bg-white/10 transition flex items-center justify-center gap-2">
